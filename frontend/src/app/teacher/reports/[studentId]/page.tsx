  ...
  return (
    <div className="p-6">
      <div ref={reportRef} className="bg-white p-6 rounded-xl shadow-md">
        <h1 className="text-2xl text-[#17171F] font-bold mb-4">
          Student Report
        </h1>
        ...
        <div className="mt-4 space-y-2 text-sm">
          <p className="text-[#17171F]">✅ 10/12 Exercises Completed</p>
          <p className="text-[#17171F]">📊 Quiz Accuracy: 87%</p>
          <p className="text-[#17171F]">
            ❓ Most Asked Topic: Human Physiology
          </p>
        </div>
      </div>
    </div>
